...
def main():
    ...
    agent = pfrl.agents.DoubleDQN(q_func, optimizer, replay_buffer, GANMA, explorer, gpu=0, replay_start_size=5000, minibatch_size=100, update_interval=50, target_update_interval=2000, phi=phi)
